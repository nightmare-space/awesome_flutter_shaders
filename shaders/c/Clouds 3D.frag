// --- Migrate Log ---
// 将 float 循环变量替换为 int 循环以兼容 SkSL，显式初始化 vec4(sum) 为 vec4(0.0)
// Replaced float loop variable with int loop for SkSL compatibility, explicitly initialize sum as vec4(0.0)
//
